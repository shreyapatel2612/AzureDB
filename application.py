...
def distance():
   ...
   cur = cnxn.cursor()
   b = "select * from all_months where latitude  = "+request.form['lat1']+" and longitude = "+request.form['lon1']+"'"
   ...
   if r.get(b):
       ...
       cur.execute("select * from all_months where latitude  = ? and longitude = ?",(request.form['lat1'], request.form['lon1'],))
       get = cur.fetchall();
       data = cur.fetchall()
